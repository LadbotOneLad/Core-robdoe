...
print("[PYTHON TRIHASH FALLBACK] Initializing robust pure Python tri-hash sovereign sealing matrix (directory-safe)...")
...
# 1. Repo mass hash (tracked files, skipping directories)
